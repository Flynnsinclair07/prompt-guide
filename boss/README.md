...
Personal automation + tooling, versioned alongside the site repo but separate
from it. These are scripts I run on my own machine, not part of the deployed site.
